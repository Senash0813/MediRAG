...
export default function ChatPage() {
  ...
  const BACKEND_URL_BY_CLUSTER: Record<number, string> = {
    1: 'https://xe33oruqs8y8co-8000.proxy.runpod.net/query',
    2: 'https://1wpa2n8ftlj5s3-8001.proxy.runpod.net/query2',
    3: 'https://ua5ta5rw1dnisn-8002.proxy.runpod.net/query3',
    4: 'https://sveicpbo1w0sai-8003.proxy.runpod.net/query4',
  };
