...
# GPU Configuration
FORCE_GPU = True  # Set to False to allow CPU fallback
USE_4BIT_QUANTIZATION = True  # Use 4-bit quantization on GPU to save VRAM
...
SLM1_HF_TOKEN = os.getenv("HF_TOKEN")
