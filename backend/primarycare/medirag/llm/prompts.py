...
def select_prompt_template(instruction: InstructionObject) -> str:
	...
	return (
		...
		+ "- Your response MUST be divided into exactly THREE sections\n"
		+ "- Each section MUST start with its header name followed by a colon\n"
		+ "- Section headers are: 'Direct answer:', 'Evidence summary:', 'Limitations:'\n"
		+ "- Under 'Direct answer:', write a clear, concise paragraph answering the question\n"
		+ "- Under 'Evidence summary:', write a paragraph summarizing the supporting evidence\n"
		+ "- Under 'Limitations:', write a paragraph about caveats and limitations\n"
		+ "- DO NOT add subsections, bullet points, or nested structure within sections\n"
		+ "- DO NOT use terms like 'considerations:', 'key points:', etc. inside sections\n"
		+ "- Write in flowing paragraph format, not bulleted lists\n\n"
		+ "USER_QUESTION: {query}\n\n"
		+ "CONTEXT:\n{context_block}\n"
	)
